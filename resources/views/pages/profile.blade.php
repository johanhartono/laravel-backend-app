                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="password" class="form-control @error('password','updatePassword')
                                                is-invalid
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control @error('name','updateProfileInformation')
                                            is-invalid
                                        @enderror" value="{{ auth()->user()->email}}" name="name">
                                        @error('name','user-profile-information.update')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                        @enderror
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="email" class="form-control @error('email','updateProfileInformation')
                                            is-invalid
                                        @enderror" value="{{ auth()->user()->email}}" name="email">
                                        @error('email','user-profile-information.update')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                        @enderror
